...
date_range = pd.date_range("2022-06-23", "2023-12-31", freq="D")
...
for mem in members:
    ...
    for doi in date_range:
        ...
        for hour in forecast_hours:
            if os.path.exists(
                f"/Users/jpsotka/repos/week2-wind/data/gefs/{doi.strftime('%Y%m%d')}{XX}/{file_name}.f{str(hour).zfill(3)}-{member}.grib2"):
        ...
        filepath = f"/Users/jpsotka/repos/week2-wind/data/gefs/{doi.strftime('%Y%m%d')}{XX}/*-{member}.grib2"
        ...
        filename = '/Users/jpsotka/repos/week2-wind/data/gefs-'+var+'-'+date+'-'+member+'.nc'
